...
LEADIN_MAGICS = [
    bytes.fromhex("3c00000030bdd1d195c9e57d31a5b99d2d9501"),
    bytes.fromhex("4000000030bdd1d195c9e57d0d85b9a1bdb99d01"),
    bytes.fromhex("4800000030bdd1d195c9e57d4195c9b585b995b9d101"),
]
KEY_PREFIXES = [
